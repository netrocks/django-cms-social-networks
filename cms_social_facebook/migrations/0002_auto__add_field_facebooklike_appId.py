...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookLike.appId'
        db.add_column(u'cmsplugin_facebooklike', 'appId',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookLike.appId'
        db.delete_column(u'cmsplugin_facebooklike', 'appId')
